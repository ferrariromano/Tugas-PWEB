...
<div id="main">
    ...
    <div class="card">
        <div class="card-header">Edit Spesialisasi</div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('spesialisasi.update', $spesialisasi->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="nama">Nama Spesialisasi</label>
                    <input type="text" name="nama" id="nama" class="form-control" value="{{ $spesialisasi->nama }}">
                </div>
